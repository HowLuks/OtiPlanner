...
export default function Home() {
  ...
  const handleCreateAppointment = () => {
    if (!clientName || !appointmentTime) {
      // Basic validation
      alert('Por favor, preencha o nome do cliente e o horário.');
      return;
    }
  
    if (appointmentStatus === 'confirmed') {
      if (!selectedServiceId || !selectedStaffId) {
        alert('Para agendamentos confirmados, o serviço e o funcionário são obrigatórios.');
        return;
      }
              ...
              <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <RadioGroup defaultValue="pending" className="col-span-3 flex gap-4" onValueChange={(value: 'confirmed' | 'pending') => setAppointmentStatus(value)}>
